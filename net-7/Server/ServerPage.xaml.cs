...
public partial class ServerPage : ContentPage {
    ...
    public ServerPage() {
        ...
        _pipeServer = new NamedPipeServerStream(PipeService.PipeName, PipeDirection.Out, 1, PipeTransmissionMode.Byte, PipeOptions.Asynchronous);
    ...
    private void InitPipeServer() {
        _pipeServer.BeginWaitForConnection(_pipeServer.EndWaitForConnection, null);
    }
